...
lyr_Dcoupmasque_0.setVisible(true);lyr_Reprojet_1.setVisible(true);
var layersList = [lyr_Dcoupmasque_0,lyr_Reprojet_1];
lyr_Reprojet_1.set('fieldAliases', {'Département': 'Département', 'MSA': 'MSA', 'MSA Globio': 'MSA Globio', });
lyr_Reprojet_1.set('fieldImages', {'Département': 'TextEdit', 'MSA': 'TextEdit', 'MSA Globio': 'TextEdit', });
lyr_Reprojet_1.set('fieldLabels', {'Département': 'inline label', 'MSA': 'inline label', 'MSA Globio': 'inline label', });
