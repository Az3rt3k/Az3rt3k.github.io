...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-966015.139494, 4757133.083918, 2163900.546388, 6818334.199612], maxZoom: 7, minZoom: 5
    })
});


map.getView().fit([-966015.139494, 4757133.083918, 2163900.546388, 6818334.199612], map.getSize());
